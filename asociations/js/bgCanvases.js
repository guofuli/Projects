...
(function(t, e) {
    ...
    if (!i.TweenLite) {
        ...
        v("Ticker", function(t, e) {
            ...
            b.call(h), h.time = h.frame = 0, h.tick = function() { d(!0) }, h.lagSmoothing = function(t, e) { p = t || 1 / _, c = Math.min(e, p, 0) }, h.sleep = function() { null != n && (m && A ? A(n) : clearTimeout(n), s = f, n = null, h === a && (o = !1)) }, h.wake = function() {
            ...
            }, h.fps(t), setTimeout(function() { m && (!n || 5 > h.frame) && h.useRAF(!1) }, 1500)
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(t) {
        ...
        return d.constructor = m, d.getRatio = function(t) {
            ...
            for (l.sort(function(t, e) {
                    return t.x - e.x }), o = new c(1, 1, null), p = u; --p > -1;) a = l[p], o = new c(a.x, a.y, o);
            ...
            return this._p1 * Math.pow(2, -10 * t) * Math.sin((t - this._p3) * a / this._p2) + 1 }, .3), s("ElasticIn", function(t) {
            return -(this._p1 * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - this._p3) * a / this._p2)) }, .3), s("ElasticInOut", function(t) {
            return 1 > (t *= 2) ? -.5 * this._p1 * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - this._p3) * a / this._p2) : .5 * this._p1 * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - this._p3) * a / this._p2) + 1 }, .45)), u("Expo", l("ExpoOut", function(t) {
            ...
            return -.5 * (Math.cos(Math.PI * t) - 1) })), h("easing.EaseLookup", { find: function(e) {
                return t.map[e] } }, !0), _(r.SlowMo, "SlowMo", "ease,"), _(i, "RoughEase", "ease,"), _(e, "SteppedEase", "ease,"), f }, !0) }), _gsScope._gsDefine && _gsScope._gsQueue.pop()();
...
(function() {
    ...
    function drawLines(p) {
        ...
        for (var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(16,217,249,' + p.active + ')';
            ctx.stroke();
        }
    }
